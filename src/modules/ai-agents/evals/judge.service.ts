...
const JUDGE_MODEL = DEFAULT_SIMPLE_MODEL;
 ...
 * aderência a um padrão de copy). Usa o modelo barato default (Claude Haiku)
 * — suficiente pro nível de avaliação binária pass/fail.
 */
@Injectable()
